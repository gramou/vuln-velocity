...
public class HomePage extends WebPage
{
		...
		public TemplateForm(String name)
		{
			...
			add(templateTextArea = new TextArea<IStringResourceStream>("templateInput",
				new PropertyModel<IStringResourceStream>(
					new Model<HomePage>(HomePage.this), "template")));
		}
	...
	private IResourceStream template = new PackageResourceStream(HomePage.class, "persons.vm");
	...
	public HomePage(final PageParameters parameters)
	{
		...
		map.put("persons", WicketApplication.getPersons());
